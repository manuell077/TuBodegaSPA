...
export const ModificarController = async (queryParams = null) => {
  ...
  divImagen.className = "componente componente--cartas-imagen";
  ...
  inputImagen.className = "input--imagen";
  divImagen.appendChild(inputImagen);
  
  const labelImagen = document.createElement("label");    
  labelImagen.for = "imagen";
  labelImagen.textContent = "Seleccione una imagen";
  labelImagen.className = "imagen-label";
